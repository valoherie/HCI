	...
	d3.csv('data.csv', function(day_data) {
			...
			var overlay = chart.append("rect")
					...
					.on("mouseover", function() {
							chart.selectAll('.focus').style("display", null);
					})
					.on("mouseout", function() {
							chart.selectAll('.focus').style("display", "none");
					})
			...
			function mousemove() {
					...
					tooltip.html(tooltip_string)
							...
							.style("top", d3.mouse(this)[1] - (tooltip[0][0].clientHeight - 750) + "px")
							.style("left", d3.mouse(this)[0] - (tooltip[0][0].clientWidth / 10) + "px");
			}
